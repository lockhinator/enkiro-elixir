defmodule Enkiro.AccountsTest do
  use Enkiro.DataCase

  alias Enkiro.Accounts

  import Enkiro.AccountsFixtures
  alias Enkiro.Accounts.{User, UserToken}
  ...
  describe "change_user_registration/2" do
    test "returns a changeset" do
      ...
      assert changeset.required == [:password, :email, :gamer_tag]
    end
  ...
  describe "change_user_email/2" do
    test "returns a user changeset" do
      ...
      assert changeset.required == [:email, :gamer_tag]
    end
  end
